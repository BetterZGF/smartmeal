...
public class PreferenceHelper {
    ...
    public static float readFloat(Context context, String fileName, String k)
    {
        SharedPreferences preference = context.getSharedPreferences(fileName,
                Context.MODE_PRIVATE);
        return preference.getFloat(k, 0f);
    }
    ...
    public static Long readLong(Context context, String fileName, String k, long defaultValue)
    {
        SharedPreferences preference = context.getSharedPreferences(fileName,
                Context.MODE_PRIVATE);
        return preference.getLong(k, defaultValue);
    }
